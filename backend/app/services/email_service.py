...
def send_welcome_email(to_email: str, user_name: str = None, plan: str = "Free", password: str = None) -> bool:
    ...
    <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <tr>
                <td style="padding: 35px 30px; background: linear-gradient(135deg, #7c3aed 0%, #4f46e5 50%, #6366f1 100%); text-align: center;">
                    <table style="margin: 0 auto;">
                        <tr>
                            <td style="vertical-align: middle; padding-right: 12px;">
                                <img src="data:image/png;base64," alt="RepriceLab" style="width: 50px; height: 50px; border-radius: 12px;" />
                            </td>
                            <td style="vertical-align: middle;">
                                <span style="color: #ffffff; font-size: 26px; font-weight: 700; letter-spacing: -0.5px;">RepriceLab.com</span>
                            </td>
                        </tr>
                    </table>
                    <p style="color: rgba(255,255,255,0.9); margin: 20px 0 0 0; font-size: 16px;">Welcome! Your Amazon repricing journey starts now</p>
                </td>
            </tr>
