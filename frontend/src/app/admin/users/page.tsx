                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-left py-3 px-2 font-medium text-gray-600">Stores</th>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="font-medium text-gray-900">
                                  {user.name || 'No name'}
                                  {user.is_admin && <Badge className="ml-2 bg-red-100 text-red-800">Admin</Badge>}
                                </p>
                                <p className="text-sm text-gray-500">{user.email}</p>
                              </div>
                            </div>
                          </td>
                          <td className="py-3 px-2">{getPlanBadge(user.subscription_plan)}</td>
                          <td className="py-3 px-2">{getStatusBadge(user.subscription_status)}</td>
                          <td className="py-3 px-2">
