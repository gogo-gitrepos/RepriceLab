...
export const metadata = { title: "RepriceLab", description: "Buy Box tracker" };
      ...
      <body className="min-h-screen bg-gray-50 text-gray-900">
        <div className="flex min-h-screen">
          <aside className="w-64 border-r bg-white/80 backdrop-blur p-4 hidden md:block">
            <h1 className="text-xl font-bold mb-4">RepriceLab</h1>
            <nav className="space-y-2">
              ...
              <a className="block px-3 py-2 rounded-md hover:bg-gray-100" href="/connect">Amazon Bağlantısı</a>
